...
MARKETPLACE_LISTING_COLUMNS: Final[list[str]] = [
    ...
    "source_goat_style_code",
    "source_goat_sku",
    "source_goat_size_system",
    "source_goat_colorway",
    "source_goat_box_condition",
    "source_goat_seller_region",
    "source_goat_release_year",
    "source_goat_condition_normalized",
    "source_goat_fees_known",
    "goat_parse_warnings",
]

MARKETPLACE_COMPARISON_COLUMNS: Final[list[str]] = [
    "product_name",
    "product_brand",
    "product_sku",
